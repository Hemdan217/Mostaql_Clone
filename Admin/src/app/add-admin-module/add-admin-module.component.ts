...
@Component({
  selector: 'app-add-admin-module',
  templateUrl: './add-admin-module.component.html',
  styleUrls: ['./add-admin-module.component.css'],
})
export class AddAdminModuleComponent implements OnInit, OnDestroy {
  isLoading!: boolean;
